 ...
 */
final class Version20250427175750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, email_client_id INT NOT NULL, date_order DATETIME NOT NULL, total_price DOUBLE PRECISION NOT NULL, quantite INT NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_F529939816E0F60A (email_client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
